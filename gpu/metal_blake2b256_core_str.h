/* Auto-generated from metal_blake2b256_core.metal -- do not edit */
static const char metal_blake2b256_core_str[] =
    "/*\n"
    " * $Revisio" "n: $\n"
    " * $Lo" "g: $\n"
    " *\n"
    " * Auto-generated by gpu/codegen/cl2metal.py from\n"
    " *   gpu_blake2b256_core.cl (RCS rev 1.2).\n"
    " *\n"
    ...
    "static inline void template_state_to_h_b256(thread template_state &st)\n"
    "{\n"
    "    for (int i = 0; i < 4; i++) {\n"
    ...
    "{\n"
    "    for (int i = 0; i < 8; i++) st.h_ulong[i] = MTL_B2B_IV[i];\n"
