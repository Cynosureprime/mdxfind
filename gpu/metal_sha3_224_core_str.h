/* Auto-generated from metal_sha3_224_core.metal -- do not edit */
static const char metal_sha3_224_core_str[] =
    "/*\n"
    " * $Revisio" "n: $\n"
    " * $Lo" "g: $\n"
    " *\n"
    " * Auto-generated by gpu/codegen/cl2metal.py from\n"
    " *   gpu_sha3_224_core.cl (RCS rev 1.2).\n"
    " *\n"
    ...
    "};\n"
    "\n"
    "static inline void template_state_to_h_sha3_224(thread template_state &st)\n"
    "{\n"
    "    for (int i = 0; i < 3; i++) {\n"
    "        ulong v = st.sp[i];\n"
    "        st.h[i * 2]     = (uint)v;\n"
    ...
    "}\n"
    "\n"
    "static inline void sha3_224_absorb_pad(thread ulong *sp, thread const uchar *data, int rem)\n"
    "{\n"
    ...
    "\n"
    "\n"
    "static inline void sha3_224_absorb_pad(thread ulong *sp, device const uchar *data, int rem)\n"
    "{\n"
    "    uchar block[KECCAK_RATE];\n"
    "    for (int i = 0; i < rem; i++) block[i] = data[i];\n"
    "    for (int i = rem; i < KECCAK_RATE; i++) block[i] = 0;\n"
    ...
    "}\n"
    "\n"
    "static inline void sha3_224_absorb_full(thread ulong *sp, thread const uchar *data)\n"
    "{\n"
    "    for (int i = 0; i < KECCAK_RATE_WORDS; i++) {\n"
    "        ulong w = 0;\n"
    "        int b = i * 8;\n"
    ...
    "\n"
    "\n"
    "static inline void sha3_224_absorb_full(thread ulong *sp, device const uchar *data)\n"
    "{\n"
    "    for (int i = 0; i < KECCAK_RATE_WORDS; i++) {\n"
    "        ulong w = 0;\n"
    "        int b = i * 8;\n"
