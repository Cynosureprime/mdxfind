 ...
 *
 * Revision 1.32  2026/05/28 04:17:53  dlr
 * sub-phase 5b4a2 Metal twin lift snefru_block into metal_common.metal mirror of gpu_common.cl rev 1.33 snefru_block byte-for-byte modulo Metal rotate-helper rotl32 substituting OpenCL rotate plus 16 KB MTL_SNEFRU_SBOX 4096 uint table donor RHash-master librhash snefru.c rhash_snefru_process_block lines 765-841 ONE PARAMETERISED block per D18.1.a snefru_block thread uint state thread const uchar block int is256 handles BOTH Snefru-128 is256 0 and Snefru-256 is256 1 same 8-round S-box transform only 3 width-divergent sites collapse to compile-time if is256 JIT folds is256 literal per emit AIR fully specialised per variant 8 rounds FIXED no security pass param MTL_SNEFRU_SBOX namespaced per Pattern 2 sibling MTL_TIGER_SBOX MTL_WRL_SBOX pointer-state thread uint state thread const uchar block matches sha256_block tiger_block twin convention static inline Pattern 3 Metal benefits from inline opposite Pascal noinline OpenCL twin schedule and state output BIG-ENDIAN donor be2me_32 be32_copy MTL_SNEFRU_BE32 BE word assembly state byte-swap into LE-uint probe frame in emit helper per feedback_be_state_primitives_need_byteswap_in_codegen const budget 16 KB within Apple Silicon 64 KB constant address space R11 scalar bitselect NOT in play XOR plus ROTR plus S-box lookup only R8 no nested block comments inserted after haval5_block diff vs OpenCL twin byte-identical modulo MTL prefix rotl32 signature C-mirror logic validated 56 of 56 cells PASS rotl32 equals rotate semantics
 *
 * Revision 1.31  2026/05/28 03:52:35  dlr
 * sub-phase 5b3c2 Metal twin lift haval5_block into metal_common.metal mirror of gpu_common.cl rev 1.32 haval5_block byte-for-byte modulo Metal rotate-helper MTL_HAVAL_ROTR32 via rotl32 complemented count shares MTL_HAVAL_F1-F5 MTL_HAVAL_ROTR32 MTL_HAVAL_IV with haval3_block CRITICAL pass 1-4 word schedules DIFFER from both 3-pass and 4-pass twins verbatim havalTransform5 transcription static inline Pattern 3 R8 no nested block comments R11 bitselect not in play pure XOR AND OR NOT MTL_HAVAL_F5 now exercised by pass 5 inserted after haval4_block diff vs OpenCL twin byte-identical modulo MTL prefix and signature metallib build clean on dev1 Apple M2 1 family AIR compiled no syntax errors
 *
 * Revision 1.30  2026/05/28 03:18:45  dlr
 * sub-phase 5b3b2 Metal twin lift haval4_block into metal_common metal mirror of gpu_common cl rev 1.31 haval4_block byte-for-byte modulo Metal rotate-helper MTL_HAVAL_ROTR32 via rotl32 complemented count shares MTL_HAVAL_F1-F5 MTL_HAVAL_ROTR32 MTL_HAVAL_IV with haval3_block CRITICAL pass 1-3 word schedules differ from 3-pass twin verbatim havalTransform4 transcription static inline Pattern 3 R8 no nested block comments R11 bitselect not in play pure XOR AND OR NOT inserted after haval3_block metallib build clean on dev1 Apple M-series compiled into AIR no syntax errors Metal twin validated 15 of 15 cells PASS dev3 M2 Max
 *
 * Revision 1.29  2026/05/28 02:16:48  dlr
 * sub-phase 5b3a2 Metal twin lift haval3_block primitive into metal_common metal mirror of gpu_common cl rev 1.30 haval3_block byte-for-byte modulo Metal rotate-helper substitution MTL_HAVAL_F1 through F5 round function macros MTL_HAVAL_ROTR32 via rotl32 with complemented count 32 minus n Metal has no OpenCL rotate builtin MTL_HAVAL_IV namespaced constant per Pattern 2 sibling MTL_TIGER_T1 MTL_WRL_SBOX pointer-state thread uint state thread const uint M matches md4_block rmd128_block rmd160_block sha1_block sha256_block static inline Pattern 3 Metal benefits from inline opposite Pascal noinline R6 not applied R11 Metal scalar bitselect not in play HAVAL F1-F5 pure XOR AND OR NOT no bitselect per feedback_metal_xcode26_bitselect_scalar R7 no nested block comments donor stripped line comments only inserted after tiger_block keeping LE-family clustered used by emit_outer_haval_concat_then_hash_metal 5b3a3-metal family helper compression body identical to OpenCL twin validated 60 of 60 C-mirror cells PASS pre-port
 *
 * Revision 1.28  2026/05/27 23:04:47  dlr
 * sub-phase 5b2b2 Metal twin lift tiger_block primitive into metal_common.metal mirror of gpu_common.cl rev 1.29 tiger_block byte-for-byte donor RHash-master librhash tiger.c rhash_tiger_process_block lines 109-151 plus tiger_sbox.c rhash_tiger_sboxes 4x256 ulong tables 8KB constant memory MTL_TIGER_SBOX MTL_TIGER_T1 through T4 namespace per Pattern 2 sibling to MTL_WRL_SBOX MTL_SHA512_K MTL_B2B_IV pointer-state convention thread ulong state thread const ulong M matches sha512_block and wrl_block Metal twin static inline Pattern 3 Metal benefits from inline opposite Pascal noinline OpenCL twin caller convention M0 through M7 must be already LE-packed donor le2me_64 swap elided constant memory budget 8 KB MTL_TIGER_SBOX combined with MTL_WRL_SBOX 16 KB equals 24 KB total well within Apple Silicon constant address space 64 KB per kernel argument R6 not applicable XOR plus shift plus multiply only no scalar bitselect needed R7 no nested block comments donor stripped uses line comments only inserted between wrl_block and mtl_hex_byte_lc keeping LE-family clustered used by emit_outer_tiger_concat_then_hash_metal 5b2b3 family helper 3-pass round structure pass1 mul 5 KeySchedule pass2 mul 7 KeySchedule pass3 mul 9 rotated arg order c a b then b c a per tiger.c line 140 142 144 feedforward state0 XOR a state1 b SUB state1 state2 PLUS c per tiger.c 148-150
 *
 * Revision 1.27  2026/05/27 22:21:41  dlr
 * sub-phase 5b2a2 Metal twin lift wrl_block primitive into metal_common.metal mirror of gpu_common.cl rev 1.28 wrl_block byte-for-byte donor librhash whirlpool.c lines 60-128 plus whirlpool_sbox.c rhash_whirlpool_sbox 8x256 ulong tables MTL_WRL_SBOX MTL_WRL_RC namespace prefix per Pattern 2 sibling to MTL_SHA512_K MTL_B2B_IV pointer-state convention thread ulong hash thread const ulong p_block matches sha512_block Metal twin static inline Pattern 3 Metal benefits from inline opposite Pascal noinline OpenCL twin caller convention M0 through M7 must be already BE-packed donor be2me_64 swap elided constant memory budget 16 KB MTL_WRL_SBOX 80 B MTL_WRL_RC well within Apple Silicon constant address space 64 KB per kernel argument R6 not applicable XOR plus S-box lookups only no bitselect R7 no nested block comments inserted between sha512_to_hex_lc and mtl_hex_byte_lc keeping BE-family clustered used by emit_outer_wrl_concat_then_hash_metal 5b2a3 family helper
 *
...
// ---- Whirlpool (ISO/IEC 10118-3) Metal twin ----
//
// Phase 5b Tier 2 sub-phase 5b.2a.2 (2026-05-27): Metal twin of
// gpu_common.cl rev 1.28 wrl_block. Mirrors librhash whirlpool.c
// rhash_whirlpool_process_block lines 60-128. MTL_ namespace prefix
// per Pattern 2 (sibling to MTL_SHA512_K, MTL_B2B_IV).
//
// Caller convention (mirrors sha512_block Metal): M[0..7] must be
// already BE-packed; donor be2me_64 swap elided.
//
// Constant memory budget: 8 * 256 * 8 = 16 KB (MTL_WRL_SBOX) + 80 B
// (MTL_WRL_RC) = 16.4 KB. Apple Silicon constant address space comfortably
// > 64 KB per kernel argument; verified PASS on dev3 M2 Max 2026-05-27.
//
// Pattern 1: thread* pointer-qualified args. Pattern 2: MTL_ namespace.
// Pattern 3: static inline (Metal benefits from inline; opposite of
// Pascal-noinline OpenCL twin per feedback_md5_block_noinline_pascal).
// R6 not applicable: WRL_OP uses only XOR + S-box lookups, no bitselect.
// R7 no nested block comments (line comments only inside body).

constant ulong MTL_WRL_RC[10] = {
...
constant ulong MTL_WRL_SBOX[8][256] = {
    {
...
// WRL_OP mirrors librhash WHIRLPOOL_OP. MTL_-prefixed to avoid name
// collision with any future translator macros.
#define MTL_WRL_OP(src, shift) ( \
    MTL_WRL_SBOX[0][(int)((src[ (shift)      & 7] >> 56)       )] ^ \
    MTL_WRL_SBOX[1][(int)((src[((shift) + 7) & 7] >> 48) & 0xff)] ^ \
    MTL_WRL_SBOX[2][(int)((src[((shift) + 6) & 7] >> 40) & 0xff)] ^ \
    MTL_WRL_SBOX[3][(int)((src[((shift) + 5) & 7] >> 32) & 0xff)] ^ \
    MTL_WRL_SBOX[4][(int)((src[((shift) + 4) & 7] >> 24) & 0xff)] ^ \
    MTL_WRL_SBOX[5][(int)((src[((shift) + 3) & 7] >> 16) & 0xff)] ^ \
    MTL_WRL_SBOX[6][(int)((src[((shift) + 2) & 7] >>  8) & 0xff)] ^ \
    MTL_WRL_SBOX[7][(int)((src[((shift) + 1) & 7]      ) & 0xff)])

static inline void wrl_block(thread ulong *hash, thread const ulong *p_block) {
    ulong K[2][8];
    ulong state[2][8];
    int m = 0;
    ...
    for (int i = 0; i < 10; i++) {
        K[m ^ 1][0] = MTL_WRL_OP(K[m], 0) ^ MTL_WRL_RC[i];
        K[m ^ 1][1] = MTL_WRL_OP(K[m], 1);
        K[m ^ 1][2] = MTL_WRL_OP(K[m], 2);
        K[m ^ 1][3] = MTL_WRL_OP(K[m], 3);
        K[m ^ 1][4] = MTL_WRL_OP(K[m], 4);
        K[m ^ 1][5] = MTL_WRL_OP(K[m], 5);
        K[m ^ 1][6] = MTL_WRL_OP(K[m], 6);
        K[m ^ 1][7] = MTL_WRL_OP(K[m], 7);

        state[m ^ 1][0] = MTL_WRL_OP(state[m], 0) ^ K[m ^ 1][0];
        state[m ^ 1][1] = MTL_WRL_OP(state[m], 1) ^ K[m ^ 1][1];
        state[m ^ 1][2] = MTL_WRL_OP(state[m], 2) ^ K[m ^ 1][2];
        state[m ^ 1][3] = MTL_WRL_OP(state[m], 3) ^ K[m ^ 1][3];
        state[m ^ 1][4] = MTL_WRL_OP(state[m], 4) ^ K[m ^ 1][4];
        state[m ^ 1][5] = MTL_WRL_OP(state[m], 5) ^ K[m ^ 1][5];
        state[m ^ 1][6] = MTL_WRL_OP(state[m], 6) ^ K[m ^ 1][6];
        state[m ^ 1][7] = MTL_WRL_OP(state[m], 7) ^ K[m ^ 1][7];
...
// ---- Tiger (Anderson + Biham 1996) Metal twin ----
//
// Phase 5b Tier 2 sub-phase 5b.2b.2 (2026-05-27): mirror of gpu_common.cl
// rev 1.29 tiger_block byte-for-byte. Donor lineage RHash-master librhash
// tiger.c rhash_tiger_process_block lines 109-151 + tiger_sbox.c
// rhash_tiger_sboxes (4x256 ulong = 8 KB total).
//
// MTL_TIGER_SBOX naming per Pattern 2 (sibling to MTL_WRL_SBOX,
// MTL_SHA512_K, MTL_B2B_IV). Pointer-state convention: thread ulong
// *state, thread const ulong *M; static inline Pattern 3 (Metal benefits
// from inline, opposite to Pascal noinline OpenCL twin).
//
...
//
// R6 not applicable: Tiger round functions use XOR / AND / OR / NOT /
// shift / multiply only -- no scalar bitselect required (avoids
// feedback_metal_xcode26_bitselect_scalar.md). R7 no nested block
// comments (line comments only inside body; donor stripped). Inserted
// between wrl_block and mtl_hex_byte_lc keeping LE-family clustered.

constant ulong MTL_TIGER_SBOX[4][256] = {
    {
...
// TIGER round/pass/key_schedule macros mirror RHash-master/librhash/
// tiger.c lines 47-101 (CPU_X64 path).
#define MTL_TIGER_T1 MTL_TIGER_SBOX[0]
#define MTL_TIGER_T2 MTL_TIGER_SBOX[1]
#define MTL_TIGER_T3 MTL_TIGER_SBOX[2]
#define MTL_TIGER_T4 MTL_TIGER_SBOX[3]

#define MTL_TIGER_ROUND(a, b, c, x, mul) \
    (c) ^= (x); \
    (a) -= MTL_TIGER_T1[(int)((uchar)(c))] ^ \
           MTL_TIGER_T2[(int)((uchar)((c) >> 16))] ^ \
           MTL_TIGER_T3[(int)((uchar)((c) >> 32))] ^ \
           MTL_TIGER_T4[(int)((uchar)((c) >> 48))]; \
    (b) += MTL_TIGER_T4[(int)((uchar)((c) >>  8))] ^ \
           MTL_TIGER_T3[(int)((uchar)((c) >> 24))] ^ \
           MTL_TIGER_T2[(int)((uchar)((c) >> 40))] ^ \
           MTL_TIGER_T1[(int)((uchar)((c) >> 56))]; \
    (b) *= (mul);

#define MTL_TIGER_PASS(a, b, c, mul) \
    MTL_TIGER_ROUND(a, b, c, x0, mul) \
    MTL_TIGER_ROUND(b, c, a, x1, mul) \
    MTL_TIGER_ROUND(c, a, b, x2, mul) \
    MTL_TIGER_ROUND(a, b, c, x3, mul) \
    MTL_TIGER_ROUND(b, c, a, x4, mul) \
    MTL_TIGER_ROUND(c, a, b, x5, mul) \
    MTL_TIGER_ROUND(a, b, c, x6, mul) \
    MTL_TIGER_ROUND(b, c, a, x7, mul)

#define MTL_TIGER_KEY_SCHEDULE \
...
static inline void tiger_block(thread ulong *state, thread const ulong *M) {
    ulong a, b, c;
...
// 113-241 mirror of gpu_common.cl rev 1.30 haval3_block byte-for-byte
// (modulo Metal/OpenCL rotate-helper differences). Public-domain donor
// (Paulo Barreto 1998). 3-pass HAVAL compression -- canonical default
// per HAVAL paper (Zheng-Pieprzyk-Seberry 1993).
//
// MTL_HAVAL_IV namespacing per Pattern 2 (sibling to MTL_TIGER_T1,
// MTL_WRL_SBOX). Pointer-state convention `thread uint *state, thread
// const uint *M` matches md4_block, rmd128_block, rmd160_block, sha1_-
// block, sha256_block. Caller M[0..31] is the 128-byte block as 32 LE-
// packed uint32 words.
//
// R6 noinline NOT applied on Metal twin per Pattern 3 (Metal benefits
// from inlining -- see feedback_md5_block_noinline_pascal.md OPPOSITE
// behavior on Apple Silicon vs Pascal). `static inline` matches all
// existing Metal block helpers.
//
// R11 Metal scalar bitselect not in play: HAVAL F1-F5 are pure XOR/
// AND/OR/NOT compositions; no bitselect needed. Per feedback_metal_-
// xcode26_bitselect_scalar.md no scalar-bitselect risk.
//
// R8 no nested block comments: donor /* */ stripped; only line
// comments used.

#define MTL_HAVAL_F1(X6, X5, X4, X3, X2, X1, X0) \
    (((X1) & ((X4) ^ (X0))) ^ ((X2) & (X5)) ^ ((X3) & (X6)) ^ (X0))

#define MTL_HAVAL_F2(X6, X5, X4, X3, X2, X1, X0) \
    (((X2) & (((X1) & (~(X3))) ^ ((X4) & (X5)) ^ (X6) ^ (X0))) ^ \
     (((X4) & ((X1) ^ (X5))) ^ ((X3) & (X5)) ^ (X0)))

#define MTL_HAVAL_F3(X6, X5, X4, X3, X2, X1, X0) \
    (((X3) & (((X1) & (X2)) ^ (X6) ^ (X0))) ^ ((X1) & (X4)) ^ \
     ((X2) & (X5)) ^ (X0))

#define MTL_HAVAL_F4(X6, X5, X4, X3, X2, X1, X0) \
    (((X4) & (((~(X2)) & (X5)) ^ ((X3) | (X6)) ^ (X1) ^ (X0))) ^ \
     ((X3) & (((X1) & (X2)) ^ (X5) ^ (X6))) ^ ((X2) & (X6)) ^ (X0))

#define MTL_HAVAL_F5(X6, X5, X4, X3, X2, X1, X0) \
    (((X1) & ((X4) ^ ((X0) & (X2) & (X3)))) ^ \
     (((X2) ^ (X0)) & (X5)) ^ ((X3) & (X6)) ^ (X0))

// HAVAL right-rotate-32. Metal has no `rotate()` builtin like OpenCL;
// use rotl32 substitute (defined above for MD5/MD4/etc.) with the
// complemented count: ROTR(v, n) = rotl32(v, 32 - n).
#define MTL_HAVAL_ROTR32(v, n) rotl32((uint)(v), (uint)(32 - (n)))

// HAVAL initial value (Pi-fractional constants). Caller initializes
// state[] to MTL_HAVAL_IV before first haval3_block call.
constant uint MTL_HAVAL_IV[8] = {
    0x243F6A88u, 0x85A308D3u, 0x13198A2Eu, 0x03707344u,
    0xA4093822u, 0x299F31D0u, 0x082EFA98u, 0xEC4E6C89u
};

static inline void haval3_block(thread uint *state, thread const uint *M) {
    ...
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E1, E0, E3, E5, E6, E2, E4), 7) + MTL_HAVAL_ROTR32(E7, 11) + M[ 0];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E0, T7, E2, E4, E5, E1, E3), 7) + MTL_HAVAL_ROTR32(E6, 11) + M[ 1];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T6, E1, E3, E4, E0, E2), 7) + MTL_HAVAL_ROTR32(E5, 11) + M[ 2];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T5, E0, E2, E3, T7, E1), 7) + MTL_HAVAL_ROTR32(E4, 11) + M[ 3];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T4, T7, E1, E2, T6, E0), 7) + MTL_HAVAL_ROTR32(E3, 11) + M[ 4];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T3, T6, E0, E1, T5, T7), 7) + MTL_HAVAL_ROTR32(E2, 11) + M[ 5];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T2, T5, T7, E0, T4, T6), 7) + MTL_HAVAL_ROTR32(E1, 11) + M[ 6];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T1, T4, T6, T7, T3, T5), 7) + MTL_HAVAL_ROTR32(E0, 11) + M[ 7];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T0, T3, T5, T6, T2, T4), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 8];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T7, T2, T4, T5, T1, T3), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 9];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T6, T1, T3, T4, T0, T2), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[10];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T5, T0, T2, T3, T7, T1), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[11];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T4, T7, T1, T2, T6, T0), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[12];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T3, T6, T0, T1, T5, T7), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[13];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T2, T5, T7, T0, T4, T6), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[14];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T1, T4, T6, T7, T3, T5), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[15];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T0, T3, T5, T6, T2, T4), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[16];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T7, T2, T4, T5, T1, T3), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[17];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T6, T1, T3, T4, T0, T2), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[18];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T5, T0, T2, T3, T7, T1), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[19];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T4, T7, T1, T2, T6, T0), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[20];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T3, T6, T0, T1, T5, T7), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[21];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T2, T5, T7, T0, T4, T6), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[22];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T1, T4, T6, T7, T3, T5), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[23];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T0, T3, T5, T6, T2, T4), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[24];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T7, T2, T4, T5, T1, T3), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[25];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T6, T1, T3, T4, T0, T2), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[26];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T5, T0, T2, T3, T7, T1), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[27];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T4, T7, T1, T2, T6, T0), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[28];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T3, T6, T0, T1, T5, T7), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[29];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T2, T5, T7, T0, T4, T6), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[30];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T1, T4, T6, T7, T3, T5), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[31];

    // PASS 2 (F2, with round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T2, T1, T0, T5, T3, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 5] + 0x452821E6u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T1, T0, T7, T4, T2, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[14] + 0x38D01377u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T0, T7, T6, T3, T1, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[26] + 0xBE5466CFu;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T7, T6, T5, T2, T0, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[18] + 0x34E90C6Cu;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T6, T5, T4, T1, T7, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[11] + 0xC0AC29B7u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T5, T4, T3, T0, T6, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[28] + 0xC97C50DDu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T4, T3, T2, T7, T5, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 7] + 0x3F84D5B5u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T3, T2, T1, T6, T4, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[16] + 0xB5470917u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T2, T1, T0, T5, T3, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 0] + 0x9216D5D9u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T1, T0, T7, T4, T2, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[23] + 0x8979FB1Bu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T0, T7, T6, T3, T1, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[20] + 0xD1310BA6u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T7, T6, T5, T2, T0, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[22] + 0x98DFB5ACu;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T6, T5, T4, T1, T7, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 1] + 0x2FFD72DBu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T5, T4, T3, T0, T6, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[10] + 0xD01ADFB7u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T4, T3, T2, T7, T5, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 4] + 0xB8E1AFEDu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T3, T2, T1, T6, T4, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 8] + 0x6A267E96u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T2, T1, T0, T5, T3, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[30] + 0xBA7C9045u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T1, T0, T7, T4, T2, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 3] + 0xF12C7F99u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T0, T7, T6, T3, T1, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[21] + 0x24A19947u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T7, T6, T5, T2, T0, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[ 9] + 0xB3916CF7u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T6, T5, T4, T1, T7, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[17] + 0x0801F2E2u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T5, T4, T3, T0, T6, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[24] + 0x858EFC16u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T4, T3, T2, T7, T5, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[29] + 0x636920D8u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T3, T2, T1, T6, T4, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 6] + 0x71574E69u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T2, T1, T0, T5, T3, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[19] + 0xA458FEA3u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T1, T0, T7, T4, T2, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[12] + 0xF4933D7Eu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T0, T7, T6, T3, T1, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[15] + 0x0D95748Fu;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T7, T6, T5, T2, T0, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[13] + 0x728EB658u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T6, T5, T4, T1, T7, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 2] + 0x718BCD58u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T5, T4, T3, T0, T6, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[25] + 0x82154AEEu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T4, T3, T2, T7, T5, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[31] + 0x7B54A41Du;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T3, T2, T1, T6, T4, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[27] + 0xC25A59B5u;

    // PASS 3 (F3, with round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T1, T2, T3, T4, T5, T0), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[19] + 0x9C30D539u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T0, T1, T2, T3, T4, T7), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 9] + 0x2AF26013u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T7, T0, T1, T2, T3, T6), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 4] + 0xC5D1B023u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T6, T7, T0, T1, T2, T5), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[20] + 0x286085F0u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T5, T6, T7, T0, T1, T4), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[28] + 0xCA417918u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T4, T5, T6, T7, T0, T3), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[17] + 0xB8DB38EFu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T3, T4, T5, T6, T7, T2), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 8] + 0x8E79DCB0u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T2, T3, T4, T5, T6, T1), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[22] + 0x603A180Eu;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T1, T2, T3, T4, T5, T0), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[29] + 0x6C9E0E8Bu;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T0, T1, T2, T3, T4, T7), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[14] + 0xB01E8A3Eu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T7, T0, T1, T2, T3, T6), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[25] + 0xD71577C1u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T6, T7, T0, T1, T2, T5), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[12] + 0xBD314B27u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T5, T6, T7, T0, T1, T4), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[24] + 0x78AF2FDAu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T4, T5, T6, T7, T0, T3), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[30] + 0x55605C60u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T3, T4, T5, T6, T7, T2), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[16] + 0xE65525F3u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T2, T3, T4, T5, T6, T1), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[26] + 0xAA55AB94u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T1, T2, T3, T4, T5, T0), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[31] + 0x57489862u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T0, T1, T2, T3, T4, T7), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[15] + 0x63E81440u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T7, T0, T1, T2, T3, T6), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 7] + 0x55CA396Au;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T6, T7, T0, T1, T2, T5), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[ 3] + 0x2AAB10B6u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T5, T6, T7, T0, T1, T4), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 1] + 0xB4CC5C34u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T4, T5, T6, T7, T0, T3), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[ 0] + 0x1141E8CEu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T3, T4, T5, T6, T7, T2), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[18] + 0xA15486AFu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T2, T3, T4, T5, T6, T1), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[27] + 0x7C72E993u;

    // Final 8 steps + feedforward.
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T1, T2, T3, T4, T5, T0), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[13] + 0xB3EE1411u;
    state[7] = E7 + T7;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T0, T1, T2, T3, T4, T7), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 6] + 0x636FBC2Au;
    state[6] = E6 + T6;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T7, T0, T1, T2, T3, T6), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[21] + 0x2BA9C55Du;
    state[5] = E5 + T5;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T6, T7, T0, T1, T2, T5), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[10] + 0x741831F6u;
    state[4] = E4 + T4;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T5, T6, T7, T0, T1, T4), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[23] + 0xCE5C3E16u;
    state[3] = E3 + T3;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T4, T5, T6, T7, T0, T3), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[11] + 0x9B87931Eu;
    state[2] = E2 + T2;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T3, T4, T5, T6, T7, T2), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 5] + 0xAFD6BA33u;
    state[1] = E1 + T1;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T2, T3, T4, T5, T6, T1), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 2] + 0x6C24CF5Cu;
    state[0] = E0 + T0;
}

// Phase 5b Tier 3 sub-phase 5b.3b.2 Metal twin: lift haval4_block from
// mhash-0.9.9.9/lib/haval.c havalTransform4 lines 244-409. Mirror of
// gpu_common.cl haval4_block byte-for-byte modulo Metal rotate-helper
// substitution (MTL_HAVAL_ROTR32 via rotl32 with complemented count).
// MTL_HAVAL_F1-F5, MTL_HAVAL_ROTR32, MTL_HAVAL_IV shared with haval3_block.
//
// CRITICAL: pass 1-3 word schedules + F-arg orderings DIFFER from the
// 3-pass twin -- verbatim transcription of havalTransform4. R8 no nested
// block comments. static inline Pattern 3 (Metal benefits from inline,
// opposite Pascal noinline R6). R11 bitselect not in play (pure XOR/AND/
// OR/NOT). C-mirror validated 60/60 cells PASS pre-port.
static inline void haval4_block(thread uint *state, thread const uint *M) {
    uint T0, T1, T2, T3, T4, T5, T6, T7;
    uint E0, E1, E2, E3, E4, E5, E6, E7;
    ...
    // PASS 1 (F1, no round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E2, E6, E1, E4, E5, E3, E0), 7) + MTL_HAVAL_ROTR32(E7, 11) + M[ 0];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E1, E5, E0, E3, E4, E2, T7), 7) + MTL_HAVAL_ROTR32(E6, 11) + M[ 1];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E0, E4, T7, E2, E3, E1, T6), 7) + MTL_HAVAL_ROTR32(E5, 11) + M[ 2];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, E3, T6, E1, E2, E0, T5), 7) + MTL_HAVAL_ROTR32(E4, 11) + M[ 3];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, E2, T5, E0, E1, T7, T4), 7) + MTL_HAVAL_ROTR32(E3, 11) + M[ 4];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, E1, T4, T7, E0, T6, T3), 7) + MTL_HAVAL_ROTR32(E2, 11) + M[ 5];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, E0, T3, T6, T7, T5, T2), 7) + MTL_HAVAL_ROTR32(E1, 11) + M[ 6];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T7, T2, T5, T6, T4, T1), 7) + MTL_HAVAL_ROTR32(E0, 11) + M[ 7];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T6, T1, T4, T5, T3, T0), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 8];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T5, T0, T3, T4, T2, T7), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 9];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T4, T7, T2, T3, T1, T6), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[10];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T3, T6, T1, T2, T0, T5), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[11];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T2, T5, T0, T1, T7, T4), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[12];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T1, T4, T7, T0, T6, T3), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[13];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T0, T3, T6, T7, T5, T2), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[14];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T7, T2, T5, T6, T4, T1), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[15];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T6, T1, T4, T5, T3, T0), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[16];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T5, T0, T3, T4, T2, T7), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[17];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T4, T7, T2, T3, T1, T6), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[18];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T3, T6, T1, T2, T0, T5), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[19];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T2, T5, T0, T1, T7, T4), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[20];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T1, T4, T7, T0, T6, T3), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[21];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T0, T3, T6, T7, T5, T2), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[22];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T7, T2, T5, T6, T4, T1), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[23];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T6, T1, T4, T5, T3, T0), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[24];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T5, T0, T3, T4, T2, T7), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[25];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T4, T7, T2, T3, T1, T6), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[26];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T3, T6, T1, T2, T0, T5), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[27];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T2, T5, T0, T1, T7, T4), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[28];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T1, T4, T7, T0, T6, T3), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[29];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T0, T3, T6, T7, T5, T2), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[30];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T7, T2, T5, T6, T4, T1), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[31];

    // PASS 2 (F2, with round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T5, T2, T0, T1, T6, T4), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 5] + 0x452821E6u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T4, T1, T7, T0, T5, T3), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[14] + 0x38D01377u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T3, T0, T6, T7, T4, T2), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[26] + 0xBE5466CFu;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T2, T7, T5, T6, T3, T1), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[18] + 0x34E90C6Cu;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T1, T6, T4, T5, T2, T0), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[11] + 0xC0AC29B7u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T0, T5, T3, T4, T1, T7), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[28] + 0xC97C50DDu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T7, T4, T2, T3, T0, T6), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 7] + 0x3F84D5B5u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T6, T3, T1, T2, T7, T5), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[16] + 0xB5470917u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T5, T2, T0, T1, T6, T4), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 0] + 0x9216D5D9u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T4, T1, T7, T0, T5, T3), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[23] + 0x8979FB1Bu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T3, T0, T6, T7, T4, T2), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[20] + 0xD1310BA6u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T2, T7, T5, T6, T3, T1), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[22] + 0x98DFB5ACu;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T1, T6, T4, T5, T2, T0), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 1] + 0x2FFD72DBu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T0, T5, T3, T4, T1, T7), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[10] + 0xD01ADFB7u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T7, T4, T2, T3, T0, T6), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 4] + 0xB8E1AFEDu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T6, T3, T1, T2, T7, T5), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 8] + 0x6A267E96u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T5, T2, T0, T1, T6, T4), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[30] + 0xBA7C9045u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T4, T1, T7, T0, T5, T3), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 3] + 0xF12C7F99u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T3, T0, T6, T7, T4, T2), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[21] + 0x24A19947u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T2, T7, T5, T6, T3, T1), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[ 9] + 0xB3916CF7u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T1, T6, T4, T5, T2, T0), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[17] + 0x0801F2E2u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T0, T5, T3, T4, T1, T7), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[24] + 0x858EFC16u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T7, T4, T2, T3, T0, T6), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[29] + 0x636920D8u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T6, T3, T1, T2, T7, T5), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 6] + 0x71574E69u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T5, T2, T0, T1, T6, T4), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[19] + 0xA458FEA3u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T4, T1, T7, T0, T5, T3), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[12] + 0xF4933D7Eu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T3, T0, T6, T7, T4, T2), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[15] + 0x0D95748Fu;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T2, T7, T5, T6, T3, T1), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[13] + 0x728EB658u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T1, T6, T4, T5, T2, T0), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 2] + 0x718BCD58u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T0, T5, T3, T4, T1, T7), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[25] + 0x82154AEEu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T7, T4, T2, T3, T0, T6), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[31] + 0x7B54A41Du;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T6, T3, T1, T2, T7, T5), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[27] + 0xC25A59B5u;

    // PASS 3 (F3, with round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T4, T3, T6, T0, T2, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[19] + 0x9C30D539u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T3, T2, T5, T7, T1, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 9] + 0x2AF26013u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T2, T1, T4, T6, T0, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 4] + 0xC5D1B023u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T1, T0, T3, T5, T7, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[20] + 0x286085F0u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T0, T7, T2, T4, T6, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[28] + 0xCA417918u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T7, T6, T1, T3, T5, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[17] + 0xB8DB38EFu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T6, T5, T0, T2, T4, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 8] + 0x8E79DCB0u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T5, T4, T7, T1, T3, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[22] + 0x603A180Eu;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T4, T3, T6, T0, T2, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[29] + 0x6C9E0E8Bu;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T3, T2, T5, T7, T1, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[14] + 0xB01E8A3Eu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T2, T1, T4, T6, T0, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[25] + 0xD71577C1u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T1, T0, T3, T5, T7, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[12] + 0xBD314B27u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T0, T7, T2, T4, T6, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[24] + 0x78AF2FDAu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T7, T6, T1, T3, T5, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[30] + 0x55605C60u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T6, T5, T0, T2, T4, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[16] + 0xE65525F3u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T5, T4, T7, T1, T3, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[26] + 0xAA55AB94u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T4, T3, T6, T0, T2, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[31] + 0x57489862u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T3, T2, T5, T7, T1, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[15] + 0x63E81440u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T2, T1, T4, T6, T0, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 7] + 0x55CA396Au;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T1, T0, T3, T5, T7, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[ 3] + 0x2AAB10B6u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T0, T7, T2, T4, T6, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 1] + 0xB4CC5C34u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T7, T6, T1, T3, T5, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[ 0] + 0x1141E8CEu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T6, T5, T0, T2, T4, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[18] + 0xA15486AFu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T5, T4, T7, T1, T3, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[27] + 0x7C72E993u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T4, T3, T6, T0, T2, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[13] + 0xB3EE1411u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T3, T2, T5, T7, T1, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 6] + 0x636FBC2Au;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T2, T1, T4, T6, T0, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[21] + 0x2BA9C55Du;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T1, T0, T3, T5, T7, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[10] + 0x741831F6u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T0, T7, T2, T4, T6, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[23] + 0xCE5C3E16u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T7, T6, T1, T3, T5, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[11] + 0x9B87931Eu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T6, T5, T0, T2, T4, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 5] + 0xAFD6BA33u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T5, T4, T7, T1, T3, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 2] + 0x6C24CF5Cu;

    // PASS 4 (F4, with round constants). Last 8 steps feedforward.
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T6, T4, T0, T5, T2, T1, T3), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[24] + 0x7A325381u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T5, T3, T7, T4, T1, T0, T2), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 4] + 0x28958677u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T4, T2, T6, T3, T0, T7, T1), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 0] + 0x3B8F4898u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T3, T1, T5, T2, T7, T6, T0), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[14] + 0x6B4BB9AFu;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T2, T0, T4, T1, T6, T5, T7), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 2] + 0xC4BFE81Bu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T1, T7, T3, T0, T5, T4, T6), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[ 7] + 0x66282193u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T0, T6, T2, T7, T4, T3, T5), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[28] + 0x61D809CCu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T7, T5, T1, T6, T3, T2, T4), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[23] + 0xFB21A991u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T6, T4, T0, T5, T2, T1, T3), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[26] + 0x487CAC60u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T5, T3, T7, T4, T1, T0, T2), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 6] + 0x5DEC8032u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T4, T2, T6, T3, T0, T7, T1), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[30] + 0xEF845D5Du;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T3, T1, T5, T2, T7, T6, T0), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[20] + 0xE98575B1u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T2, T0, T4, T1, T6, T5, T7), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[18] + 0xDC262302u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T1, T7, T3, T0, T5, T4, T6), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[25] + 0xEB651B88u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T0, T6, T2, T7, T4, T3, T5), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[19] + 0x23893E81u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T7, T5, T1, T6, T3, T2, T4), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 3] + 0xD396ACC5u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T6, T4, T0, T5, T2, T1, T3), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[22] + 0x0F6D6FF3u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T5, T3, T7, T4, T1, T0, T2), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[11] + 0x83F44239u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T4, T2, T6, T3, T0, T7, T1), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[31] + 0x2E0B4482u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T3, T1, T5, T2, T7, T6, T0), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[21] + 0xA4842004u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T2, T0, T4, T1, T6, T5, T7), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 8] + 0x69C8F04Au;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T1, T7, T3, T0, T5, T4, T6), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[27] + 0x9E1F9B5Eu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T0, T6, T2, T7, T4, T3, T5), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[12] + 0x21C66842u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T7, T5, T1, T6, T3, T2, T4), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 9] + 0xF6E96C9Au;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T6, T4, T0, T5, T2, T1, T3), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 1] + 0x670C9C61u;
    state[7] = E7 + T7;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T5, T3, T7, T4, T1, T0, T2), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[29] + 0xABD388F0u;
    state[6] = E6 + T6;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T4, T2, T6, T3, T0, T7, T1), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 5] + 0x6A51A0D2u;
    state[5] = E5 + T5;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T3, T1, T5, T2, T7, T6, T0), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[15] + 0xD8542F68u;
    state[4] = E4 + T4;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T2, T0, T4, T1, T6, T5, T7), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[17] + 0x960FA728u;
    state[3] = E3 + T3;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T1, T7, T3, T0, T5, T4, T6), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[10] + 0xAB5133A3u;
    state[2] = E2 + T2;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T0, T6, T2, T7, T4, T3, T5), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[16] + 0x6EEF0B6Cu;
    state[1] = E1 + T1;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T7, T5, T1, T6, T3, T2, T4), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[13] + 0x137A3BE4u;
    state[0] = E0 + T0;
}

// Phase 5b Tier 3 sub-phase 5b.3c.2 Metal twin: lift haval5_block from
// mhash-0.9.9.9/lib/haval.c havalTransform5 lines 412-615. Mirror of
// gpu_common.cl haval5_block byte-for-byte modulo Metal rotate-helper
// substitution (MTL_HAVAL_ROTR32 via rotl32 with complemented count).
// MTL_HAVAL_F1-F5, MTL_HAVAL_ROTR32, MTL_HAVAL_IV shared with haval3_block.
//
// CRITICAL: pass 1-4 word schedules + F-arg orderings DIFFER from BOTH the
// 3-pass AND 4-pass twins -- verbatim transcription of havalTransform5. R8
// no nested block comments. static inline Pattern 3 (Metal benefits from
// inline, opposite Pascal noinline R6). R11 bitselect not in play (pure
// XOR/AND/OR/NOT). C-mirror validated 60/60 cells PASS pre-port.
static inline void haval5_block(thread uint *state, thread const uint *M) {
    uint T0, T1, T2, T3, T4, T5, T6, T7;
    uint E0, E1, E2, E3, E4, E5, E6, E7;
    ...
    // PASS 1 (F1, no round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E3, E4, E1, E0, E5, E2, E6), 7) + MTL_HAVAL_ROTR32(E7, 11) + M[ 0];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E2, E3, E0, T7, E4, E1, E5), 7) + MTL_HAVAL_ROTR32(E6, 11) + M[ 1];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E1, E2, T7, T6, E3, E0, E4), 7) + MTL_HAVAL_ROTR32(E5, 11) + M[ 2];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(E0, E1, T6, T5, E2, T7, E3), 7) + MTL_HAVAL_ROTR32(E4, 11) + M[ 3];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, E0, T5, T4, E1, T6, E2), 7) + MTL_HAVAL_ROTR32(E3, 11) + M[ 4];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T7, T4, T3, E0, T5, E1), 7) + MTL_HAVAL_ROTR32(E2, 11) + M[ 5];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T6, T3, T2, T7, T4, E0), 7) + MTL_HAVAL_ROTR32(E1, 11) + M[ 6];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T5, T2, T1, T6, T3, T7), 7) + MTL_HAVAL_ROTR32(E0, 11) + M[ 7];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T4, T1, T0, T5, T2, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 8];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T3, T0, T7, T4, T1, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 9];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T2, T7, T6, T3, T0, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[10];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T1, T6, T5, T2, T7, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[11];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T0, T5, T4, T1, T6, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[12];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T7, T4, T3, T0, T5, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[13];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T6, T3, T2, T7, T4, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[14];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T5, T2, T1, T6, T3, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[15];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T4, T1, T0, T5, T2, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[16];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T3, T0, T7, T4, T1, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[17];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T2, T7, T6, T3, T0, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[18];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T1, T6, T5, T2, T7, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[19];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T0, T5, T4, T1, T6, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[20];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T7, T4, T3, T0, T5, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[21];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T6, T3, T2, T7, T4, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[22];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T5, T2, T1, T6, T3, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[23];

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T3, T4, T1, T0, T5, T2, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[24];
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T2, T3, T0, T7, T4, T1, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[25];
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T1, T2, T7, T6, T3, T0, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[26];
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T0, T1, T6, T5, T2, T7, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[27];
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T7, T0, T5, T4, T1, T6, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[28];
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T6, T7, T4, T3, T0, T5, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[29];
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T5, T6, T3, T2, T7, T4, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[30];
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F1(T4, T5, T2, T1, T6, T3, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[31];

    // PASS 2 (F2, with round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T2, T1, T0, T3, T4, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 5] + 0x452821E6u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T1, T0, T7, T2, T3, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[14] + 0x38D01377u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T0, T7, T6, T1, T2, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[26] + 0xBE5466CFu;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T7, T6, T5, T0, T1, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[18] + 0x34E90C6Cu;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T6, T5, T4, T7, T0, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[11] + 0xC0AC29B7u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T5, T4, T3, T6, T7, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[28] + 0xC97C50DDu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T4, T3, T2, T5, T6, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 7] + 0x3F84D5B5u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T3, T2, T1, T4, T5, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[16] + 0xB5470917u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T2, T1, T0, T3, T4, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 0] + 0x9216D5D9u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T1, T0, T7, T2, T3, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[23] + 0x8979FB1Bu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T0, T7, T6, T1, T2, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[20] + 0xD1310BA6u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T7, T6, T5, T0, T1, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[22] + 0x98DFB5ACu;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T6, T5, T4, T7, T0, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 1] + 0x2FFD72DBu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T5, T4, T3, T6, T7, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[10] + 0xD01ADFB7u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T4, T3, T2, T5, T6, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 4] + 0xB8E1AFEDu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T3, T2, T1, T4, T5, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 8] + 0x6A267E96u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T2, T1, T0, T3, T4, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[30] + 0xBA7C9045u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T1, T0, T7, T2, T3, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 3] + 0xF12C7F99u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T0, T7, T6, T1, T2, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[21] + 0x24A19947u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T7, T6, T5, T0, T1, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[ 9] + 0xB3916CF7u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T6, T5, T4, T7, T0, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[17] + 0x0801F2E2u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T5, T4, T3, T6, T7, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[24] + 0x858EFC16u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T4, T3, T2, T5, T6, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[29] + 0x636920D8u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T3, T2, T1, T4, T5, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 6] + 0x71574E69u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T6, T2, T1, T0, T3, T4, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[19] + 0xA458FEA3u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T5, T1, T0, T7, T2, T3, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[12] + 0xF4933D7Eu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T4, T0, T7, T6, T1, T2, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[15] + 0x0D95748Fu;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T3, T7, T6, T5, T0, T1, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[13] + 0x728EB658u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T2, T6, T5, T4, T7, T0, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 2] + 0x718BCD58u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T1, T5, T4, T3, T6, T7, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[25] + 0x82154AEEu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T0, T4, T3, T2, T5, T6, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[31] + 0x7B54A41Du;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F2(T7, T3, T2, T1, T4, T5, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[27] + 0xC25A59B5u;

    // PASS 3 (F3, with round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T6, T0, T4, T3, T1, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[19] + 0x9C30D539u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T5, T7, T3, T2, T0, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 9] + 0x2AF26013u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T4, T6, T2, T1, T7, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 4] + 0xC5D1B023u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T3, T5, T1, T0, T6, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[20] + 0x286085F0u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T2, T4, T0, T7, T5, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[28] + 0xCA417918u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T1, T3, T7, T6, T4, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[17] + 0xB8DB38EFu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T0, T2, T6, T5, T3, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 8] + 0x8E79DCB0u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T7, T1, T5, T4, T2, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[22] + 0x603A180Eu;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T6, T0, T4, T3, T1, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[29] + 0x6C9E0E8Bu;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T5, T7, T3, T2, T0, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[14] + 0xB01E8A3Eu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T4, T6, T2, T1, T7, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[25] + 0xD71577C1u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T3, T5, T1, T0, T6, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[12] + 0xBD314B27u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T2, T4, T0, T7, T5, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[24] + 0x78AF2FDAu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T1, T3, T7, T6, T4, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[30] + 0x55605C60u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T0, T2, T6, T5, T3, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[16] + 0xE65525F3u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T7, T1, T5, T4, T2, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[26] + 0xAA55AB94u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T6, T0, T4, T3, T1, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[31] + 0x57489862u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T5, T7, T3, T2, T0, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[15] + 0x63E81440u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T4, T6, T2, T1, T7, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 7] + 0x55CA396Au;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T3, T5, T1, T0, T6, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[ 3] + 0x2AAB10B6u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T2, T4, T0, T7, T5, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 1] + 0xB4CC5C34u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T1, T3, T7, T6, T4, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[ 0] + 0x1141E8CEu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T0, T2, T6, T5, T3, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[18] + 0xA15486AFu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T7, T1, T5, T4, T2, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[27] + 0x7C72E993u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T2, T6, T0, T4, T3, T1, T5), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[13] + 0xB3EE1411u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T1, T5, T7, T3, T2, T0, T4), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 6] + 0x636FBC2Au;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T0, T4, T6, T2, T1, T7, T3), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[21] + 0x2BA9C55Du;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T7, T3, T5, T1, T0, T6, T2), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[10] + 0x741831F6u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T6, T2, T4, T0, T7, T5, T1), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[23] + 0xCE5C3E16u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T5, T1, T3, T7, T6, T4, T0), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[11] + 0x9B87931Eu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T4, T0, T2, T6, T5, T3, T7), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[ 5] + 0xAFD6BA33u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F3(T3, T7, T1, T5, T4, T2, T6), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 2] + 0x6C24CF5Cu;

    // PASS 4 (F4, with round constants).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T1, T5, T3, T2, T0, T4, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[24] + 0x7A325381u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T0, T4, T2, T1, T7, T3, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 4] + 0x28958677u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T7, T3, T1, T0, T6, T2, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 0] + 0x3B8F4898u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T6, T2, T0, T7, T5, T1, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[14] + 0x6B4BB9AFu;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T5, T1, T7, T6, T4, T0, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 2] + 0xC4BFE81Bu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T4, T0, T6, T5, T3, T7, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[ 7] + 0x66282193u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T3, T7, T5, T4, T2, T6, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[28] + 0x61D809CCu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T2, T6, T4, T3, T1, T5, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[23] + 0xFB21A991u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T1, T5, T3, T2, T0, T4, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[26] + 0x487CAC60u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T0, T4, T2, T1, T7, T3, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 6] + 0x5DEC8032u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T7, T3, T1, T0, T6, T2, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[30] + 0xEF845D5Du;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T6, T2, T0, T7, T5, T1, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[20] + 0xE98575B1u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T5, T1, T7, T6, T4, T0, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[18] + 0xDC262302u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T4, T0, T6, T5, T3, T7, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[25] + 0xEB651B88u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T3, T7, T5, T4, T2, T6, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[19] + 0x23893E81u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T2, T6, T4, T3, T1, T5, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 3] + 0xD396ACC5u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T1, T5, T3, T2, T0, T4, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[22] + 0x0F6D6FF3u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T0, T4, T2, T1, T7, T3, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[11] + 0x83F44239u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T7, T3, T1, T0, T6, T2, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[31] + 0x2E0B4482u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T6, T2, T0, T7, T5, T1, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[21] + 0xA4842004u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T5, T1, T7, T6, T4, T0, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 8] + 0x69C8F04Au;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T4, T0, T6, T5, T3, T7, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[27] + 0x9E1F9B5Eu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T3, T7, T5, T4, T2, T6, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[12] + 0x21C66842u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T2, T6, T4, T3, T1, T5, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[ 9] + 0xF6E96C9Au;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T1, T5, T3, T2, T0, T4, T6), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 1] + 0x670C9C61u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T0, T4, T2, T1, T7, T3, T5), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[29] + 0xABD388F0u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T7, T3, T1, T0, T6, T2, T4), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[ 5] + 0x6A51A0D2u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T6, T2, T0, T7, T5, T1, T3), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[15] + 0xD8542F68u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T5, T1, T7, T6, T4, T0, T2), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[17] + 0x960FA728u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T4, T0, T6, T5, T3, T7, T1), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[10] + 0xAB5133A3u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T3, T7, T5, T4, T2, T6, T0), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[16] + 0x6EEF0B6Cu;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F4(T2, T6, T4, T3, T1, T5, T7), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[13] + 0x137A3BE4u;

    // PASS 5 (F5, with round constants). Final 8 steps compute T[i] AND
    // feedforward into state[i] (donor lines 603-610: E[7] += T[7] = ...).
    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T2, T5, T0, T6, T4, T3, T1), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[27] + 0xBA3BF050u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T1, T4, T7, T5, T3, T2, T0), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 3] + 0x7EFB2A98u;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T0, T3, T6, T4, T2, T1, T7), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[21] + 0xA1F1651Du;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T7, T2, T5, T3, T1, T0, T6), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[26] + 0x39AF0176u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T6, T1, T4, T2, T0, T7, T5), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[17] + 0x66CA593Eu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T5, T0, T3, T1, T7, T6, T4), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[11] + 0x82430E88u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T4, T7, T2, T0, T6, T5, T3), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[20] + 0x8CEE8619u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T3, T6, T1, T7, T5, T4, T2), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[29] + 0x456F9FB4u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T2, T5, T0, T6, T4, T3, T1), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[19] + 0x7D84A5C3u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T1, T4, T7, T5, T3, T2, T0), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 0] + 0x3B8B5EBEu;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T0, T3, T6, T4, T2, T1, T7), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[12] + 0xE06F75D8u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T7, T2, T5, T3, T1, T0, T6), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[ 7] + 0x85C12073u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T6, T1, T4, T2, T0, T7, T5), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[13] + 0x401A449Fu;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T5, T0, T3, T1, T7, T6, T4), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[ 8] + 0x56C16AA6u;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T4, T7, T2, T0, T6, T5, T3), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[31] + 0x4ED3AA62u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T3, T6, T1, T7, T5, T4, T2), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[10] + 0x363F7706u;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T2, T5, T0, T6, T4, T3, T1), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 5] + 0x1BFEDF72u;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T1, T4, T7, T5, T3, T2, T0), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[ 9] + 0x429B023Du;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T0, T3, T6, T4, T2, T1, T7), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[14] + 0x37D0D724u;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T7, T2, T5, T3, T1, T0, T6), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[30] + 0xD00A1248u;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T6, T1, T4, T2, T0, T7, T5), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[18] + 0xDB0FEAD3u;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T5, T0, T3, T1, T7, T6, T4), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[ 6] + 0x49F1C09Bu;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T4, T7, T2, T0, T6, T5, T3), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[28] + 0x075372C9u;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T3, T6, T1, T7, T5, T4, T2), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[24] + 0x80991B7Bu;

    T7 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T2, T5, T0, T6, T4, T3, T1), 7) + MTL_HAVAL_ROTR32(T7, 11) + M[ 2] + 0x25D479D8u;
    state[7] = E7 + T7;
    T6 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T1, T4, T7, T5, T3, T2, T0), 7) + MTL_HAVAL_ROTR32(T6, 11) + M[23] + 0xF6E8DEF7u;
    state[6] = E6 + T6;
    T5 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T0, T3, T6, T4, T2, T1, T7), 7) + MTL_HAVAL_ROTR32(T5, 11) + M[16] + 0xE3FE501Au;
    state[5] = E5 + T5;
    T4 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T7, T2, T5, T3, T1, T0, T6), 7) + MTL_HAVAL_ROTR32(T4, 11) + M[22] + 0xB6794C3Bu;
    state[4] = E4 + T4;
    T3 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T6, T1, T4, T2, T0, T7, T5), 7) + MTL_HAVAL_ROTR32(T3, 11) + M[ 4] + 0x976CE0BDu;
    state[3] = E3 + T3;
    T2 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T5, T0, T3, T1, T7, T6, T4), 7) + MTL_HAVAL_ROTR32(T2, 11) + M[ 1] + 0x04C006BAu;
    state[2] = E2 + T2;
    T1 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T4, T7, T2, T0, T6, T5, T3), 7) + MTL_HAVAL_ROTR32(T1, 11) + M[25] + 0xC1A94FB6u;
    state[1] = E1 + T1;
    T0 = MTL_HAVAL_ROTR32(MTL_HAVAL_F5(T3, T6, T1, T7, T5, T4, T2), 7) + MTL_HAVAL_ROTR32(T0, 11) + M[15] + 0x409F60C4u;
    state[0] = E0 + T0;
}


// Phase 5b Tier 4 sub-phase 5b.4a.2 (2026-05-27): Metal twin lift
// snefru_block into metal_common.metal, mirror of gpu_common.cl rev 1.33
// snefru_block byte-for-byte modulo the Metal rotate-helper (rotl32
// substituting OpenCL rotate). Donor RHash-master/librhash/snefru.c
// rhash_snefru_process_block lines 765-841 + 16 KB rhash_snefru_sbox.
//
// ONE PARAMETERISED block (D18.1.a): snefru_block(state, block, is256)
// handles BOTH widths. is256 baked as a literal per emit so the AIR is
// fully specialised per variant (no runtime branch). 8 rounds FIXED.
// MTL_SNEFRU_SBOX namespaced per Pattern 2 (sibling MTL_TIGER_SBOX,
// MTL_WRL_SBOX). pointer-state thread uint *state + thread const uchar
// *block matches the sha256_block / tiger_block twin convention.
// static inline Pattern 3 (Metal benefits from inline, opposite Pascal
// noinline OpenCL twin). Schedule + state output BIG-ENDIAN (donor
// be2me_32 / be32_copy); state byte-swap into the LE-uint probe frame is
// in the emit helper per feedback_be_state_primitives_need_byteswap_in_-
// codegen.md. Constant budget 16 KB; well within Apple Silicon 64 KB
// per-kernel constant address space. R11 scalar bitselect NOT in play
...
// MTL_SNEFRU_BE32: big-endian uint32 from 4 message bytes at p+4*i
// (mirrors donor be2me_32(block[i])).
#define MTL_SNEFRU_BE32(p, i) \
    ( ((uint)(p)[4*(i)+0] << 24) | ((uint)(p)[4*(i)+1] << 16) \
    | ((uint)(p)[4*(i)+2] <<  8) |  (uint)(p)[4*(i)+3] )

// snefru_block: Snefru core transform on one data block. state[8] is the
// 512-bit hashing state (caller zero-inits; Snefru IV all-zero). block is
// raw data-block bytes: 48 for SNE128 (is256=0), 32 for SNE256 (is256=1).
// Donor lineage rhash_snefru_process_block snefru.c:765-841.
static inline void snefru_block(thread uint *state, thread const uchar *block,
                                int is256) {
    uint W[16];
    uint rot;
    int sbi;
    ...
    if (is256) {
        ...
        W[ 8] = MTL_SNEFRU_BE32(block, 0); W[ 9] = MTL_SNEFRU_BE32(block, 1);
        W[10] = MTL_SNEFRU_BE32(block, 2); W[11] = MTL_SNEFRU_BE32(block, 3);
        W[12] = MTL_SNEFRU_BE32(block, 4); W[13] = MTL_SNEFRU_BE32(block, 5);
        W[14] = MTL_SNEFRU_BE32(block, 6); W[15] = MTL_SNEFRU_BE32(block, 7);
    } else {
        W[4] = MTL_SNEFRU_BE32(block, 0); W[5] = MTL_SNEFRU_BE32(block, 1);
        W[6] = MTL_SNEFRU_BE32(block, 2); W[7] = MTL_SNEFRU_BE32(block, 3);
        W[ 8] = MTL_SNEFRU_BE32(block, 4); W[ 9] = MTL_SNEFRU_BE32(block, 5);
        W[10] = MTL_SNEFRU_BE32(block, 6); W[11] = MTL_SNEFRU_BE32(block, 7);
        W[12] = MTL_SNEFRU_BE32(block, 8); W[13] = MTL_SNEFRU_BE32(block, 9);
        W[14] = MTL_SNEFRU_BE32(block,10); W[15] = MTL_SNEFRU_BE32(block,11);
    }

    for (sbi = 0; sbi < 8; sbi++) {
        constant uint *sbox = MTL_SNEFRU_SBOX + 512 * sbi;
        for (rot = 0x18100810u; rot; rot >>= 8) {
            uint x;
#define MTL_SNEFRU_UPD(i) \
            x = sbox[((((i) << 7) & 0x100) + (W[(i)] & 0xff))]; \
            W[((i) - 1) & 0x0f] ^= x; \
            if ((i) >= 2) W[((i) - 1) & 0x0f] = \
                rotl32(W[((i) - 1) & 0x0f], (uint)(32 - ((uchar)rot))); \
            W[((i) + 1) & 0x0f] ^= x;
            MTL_SNEFRU_UPD(0);  MTL_SNEFRU_UPD(1);  MTL_SNEFRU_UPD(2);  MTL_SNEFRU_UPD(3);
            MTL_SNEFRU_UPD(4);  MTL_SNEFRU_UPD(5);  MTL_SNEFRU_UPD(6);  MTL_SNEFRU_UPD(7);
            MTL_SNEFRU_UPD(8);  MTL_SNEFRU_UPD(9);  MTL_SNEFRU_UPD(10); MTL_SNEFRU_UPD(11);
            MTL_SNEFRU_UPD(12); MTL_SNEFRU_UPD(13); MTL_SNEFRU_UPD(14); MTL_SNEFRU_UPD(15);
#undef MTL_SNEFRU_UPD
            W[ 0] = rotl32(W[ 0], (uint)(32 - ((uchar)rot)));
            W[15] = rotl32(W[15], (uint)(32 - ((uchar)rot)));
        }
    }
...
// gpu_common.cl gost_block. Byte-for-byte mirror modulo the Metal
// conventions (constant vs __constant, static inline Pattern 3, thread
// uint* state / thread const uint* M). Donor: in-tree gosthash/gosthash.c
// gosthash_compress (the LIVE CPU oracle for e125 GOSTMD5PASS). GOST
// 28147-89 TEST S-box set (Saarinen 1998 / RFC 4357), NOT CryptoPro.
// MTL_GOST_SBOX_1..4 namespaced per Pattern 2 (sibling MTL_SNEFRU_SBOX,
// MTL_TIGER_SBOX). 4 KB constant. The running mod-2^256 checksum sum[8] +
...
constant uint MTL_GOST_SBOX_2[256] = {
...
constant uint MTL_GOST_SBOX_3[256] = {
...
constant uint MTL_GOST_SBOX_4[256] = {
...
#define MTL_GOST_GE_ROUND(k1, k2) \
    t = (k1) + r; \
    l ^= MTL_GOST_SBOX_1[t & 0xff] ^ MTL_GOST_SBOX_2[(t >> 8) & 0xff] ^ \
         MTL_GOST_SBOX_3[(t >> 16) & 0xff] ^ MTL_GOST_SBOX_4[t >> 24]; \
    t = (k2) + l; \
    r ^= MTL_GOST_SBOX_1[t & 0xff] ^ MTL_GOST_SBOX_2[(t >> 8) & 0xff] ^ \
         MTL_GOST_SBOX_3[(t >> 16) & 0xff] ^ MTL_GOST_SBOX_4[t >> 24];

// GOST_ENCRYPT (donor :81-100): 32 rounds = 3x forward key order + 1x reverse,
// then swap r/l.
#define MTL_GOST_GE_ENCRYPT(key) \
    MTL_GOST_GE_ROUND(key[0], key[1]) MTL_GOST_GE_ROUND(key[2], key[3]) \
    MTL_GOST_GE_ROUND(key[4], key[5]) MTL_GOST_GE_ROUND(key[6], key[7]) \
    MTL_GOST_GE_ROUND(key[0], key[1]) MTL_GOST_GE_ROUND(key[2], key[3]) \
    MTL_GOST_GE_ROUND(key[4], key[5]) MTL_GOST_GE_ROUND(key[6], key[7]) \
    MTL_GOST_GE_ROUND(key[0], key[1]) MTL_GOST_GE_ROUND(key[2], key[3]) \
    MTL_GOST_GE_ROUND(key[4], key[5]) MTL_GOST_GE_ROUND(key[6], key[7]) \
    MTL_GOST_GE_ROUND(key[7], key[6]) MTL_GOST_GE_ROUND(key[5], key[4]) \
    MTL_GOST_GE_ROUND(key[3], key[2]) MTL_GOST_GE_ROUND(key[1], key[0]) \
    t = r; r = l; l = t;

static inline void gost_block(thread uint *h, thread const uint *m) {
    int i;
