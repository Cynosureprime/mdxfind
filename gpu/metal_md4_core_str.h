/* Auto-generated from metal_md4_core.metal -- do not edit */
static const char metal_md4_core_str[] =
    "/*\n"
    " * $Revisio" "n: $\n"
    " * $Lo" "g: $\n"
    " *\n"
    " * Auto-generated by gpu/codegen/cl2metal.py from\n"
    " *   gpu_md4_core.cl (RCS rev 1.3).\n"
    " *\n"
    ...
    "static inline void md4_compress(thread uint &hx, thread uint &hy, thread uint &hz, thread uint &hw, thread uint *M)\n"
    "{\n"
