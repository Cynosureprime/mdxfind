/* Auto-generated from metal_keccak256_core.metal -- do not edit */
static const char metal_keccak256_core_str[] =
    "/*\n"
    " * $Revisio" "n: $\n"
    " * $Lo" "g: $\n"
    " *\n"
    " * Auto-generated by gpu/codegen/cl2metal.py from\n"
    " *   gpu_keccak256_core.cl (RCS rev 1.2).\n"
    " *\n"
    ...
    "static inline void template_state_to_h_keccak256(thread template_state &st)\n"
    "{\n"
    ...
    "static inline void keccak256_absorb_pad(thread ulong *sp, thread const uchar *data, int rem)\n"
    "{\n"
    ...
    "\n"
    "static inline void keccak256_absorb_pad(thread ulong *sp, device const uchar *data, int rem)\n"
    "{\n"
    "    /* Build the final block in private memory: copy partial bytes, zero the\n"
    "     * rest, then OR in suffix at offset rem and 0x80 at offset rate-1.\n"
    "     * Note: positions rem and rate-1 may collide when rem == rate-1; in that\n"
    ...
    "static inline void keccak256_absorb_full(thread ulong *sp, thread const uchar *data)\n"
    "{\n"
    "    for (int i = 0; i < KECCAK_RATE_WORDS; i++) {\n"
    "        ulong w = 0;\n"
    "        int b = i * 8;\n"
    ...
    "/* Phase 2d.7b: device-const overload (mirror of thread-const above). Selected by Metal's overload resolution when called from template_finalize's hot path with a device-const slice of buf_scratch_pool. */\n"
    "\n"
    "static inline void keccak256_absorb_full(thread ulong *sp, device const uchar *data)\n"
    "{\n"
    "    for (int i = 0; i < KECCAK_RATE_WORDS; i++) {\n"
    "        ulong w = 0;\n"
    "        int b = i * 8;\n"
