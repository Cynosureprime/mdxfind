...
static inline void template_state_to_h_sha3_384(template_state *st) {
...
static inline void sha3_384_absorb_pad(ulong *sp, const uchar *data, int rem) {
...
static inline void sha3_384_absorb_full(ulong *sp, const uchar *data) {
    for (int i = 0; i < KECCAK_RATE_WORDS; i++) {
        ulong w = 0;
        int b = i * 8;
        w |= (ulong)data[b];
