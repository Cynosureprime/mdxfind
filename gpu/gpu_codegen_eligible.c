 ...
 *
 * Phase 5b unlocks the remaining 22 family members (md2 / gost /
 * haval(13 variants) / rmd128 / tiger / wrl / sne128 / sne256 outers)
 * after the corresponding *_block primitives land in gpu_common.cl.
 */
