/*
 * $Revision: 1.1 $
 * $Log: metal_ntlmh_core.metal,v $
 * Revision 1.1  2026/09/17 03:23:50  dlr
 * Metal twin of gpu_ntlmh_core.cl, translated by codegen/cl2metal.py. Part of closing the OpenCL to Metal core-parity gap: 48 Metal cores against 55 OpenCL, now 55 to 55. Generated, not hand-written - do NOT edit directly; edit the OpenCL twin and re-run the translator, with Apple-specific tweaks in codegen/cl2metal_overrides/ntlmh.yaml.
 *
 *
