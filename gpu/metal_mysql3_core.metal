/*
 * $Revision: 1.1 $
 * $Log: metal_mysql3_core.metal,v $
 * Revision 1.1  2026/09/17 03:23:50  dlr
 * Metal twin of gpu_mysql3_core.cl, translated by codegen/cl2metal.py. Part of closing the OpenCL to Metal core-parity gap: 48 Metal cores against 55 OpenCL, now 55 to 55. Generated, not hand-written - do NOT edit directly; edit the OpenCL twin and re-run the translator, with Apple-specific tweaks in codegen/cl2metal_overrides/mysql3.yaml.
 *
 *
 * Auto-generated by gpu/codegen/cl2metal.py from
 *   gpu_mysql3_core.cl (RCS rev 1.2).
 *
...
static inline void mysql3_compute(thread const uchar *data, int len, thread uint &nr_out, thread uint &nr2_out)
{
    uint nr = 1345345333u;
...
static inline void mysql3_compute(device const uchar *data, int len, thread uint &nr_out, thread uint &nr2_out)
{
    uint nr = 1345345333u;
    uint nr2 = 0x12345671u;
    uint add = 7u;
