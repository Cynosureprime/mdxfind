/*
 * $Revision: 1.1 $
 * $Log: metal_md6256_core.metal,v $
 * Revision 1.1  2026/09/17 03:23:50  dlr
 * Metal twin of gpu_md6256_core.cl, translated by codegen/cl2metal.py. Part of closing the OpenCL to Metal core-parity gap: 48 Metal cores against 55 OpenCL, now 55 to 55. Generated, not hand-written - do NOT edit directly; edit the OpenCL twin and re-run the translator, with Apple-specific tweaks in codegen/cl2metal_overrides/md6256.yaml.
 *
 *
 * Auto-generated by gpu/codegen/cl2metal.py from
 *   gpu_md6256_core.cl (RCS rev 1.2).
 *
...
constant ulong MD6CORE_S0    = 0x0123456789abcdefUL;
constant ulong MD6CORE_Smask = 0x7311c2812425cfa0UL;
...
static inline void md6core_compress_loop(thread ulong *A)
{
    ulong x;
    ulong S = MD6CORE_S0;
    int i = MD6CORE_n;
...
static inline void md6core_pack_and_compress(thread uint *digest_words,
