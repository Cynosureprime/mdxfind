...
static const char gpu_md5mask_str[] =
    ...
    "    switch (id) {\n"
    "        case 0: return cs_d[idx];\n"
    "        case 1: return cs_l[idx];\n"
    "        case 2: return cs_u[idx];\n"
    "        case 3: return cs_s[idx];\n"
    "        case 4: return (uchar)(0x20 + idx);  /* ?a: 0x20..0x7e */\n"
    "        case 5: return (uchar)idx;            /* ?b: 0x00..0xff */\n"
    ...
    "        append_combos *= charset_size(mask_desc[params.n_prepend + i]);\n"
    "\n"
    ...
    "            cand[i] = charset_char(mask_desc[i], pidx % sz);\n"
    "            pidx /= sz;\n"
    "        }\n"
    ...
    "            uchar csid = mask_desc[params.n_prepend + i];\n"
    "            uint sz = charset_size(csid);\n"
    "            cand[clen + i] = charset_char(csid, aidx % sz);\n"
    "            aidx /= sz;\n"
    "        }\n"
