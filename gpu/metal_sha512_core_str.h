/* Auto-generated from metal_sha512_core.metal -- do not edit */
static const char metal_sha512_core_str[] =
    "/*\n"
    " * $Revision: 1.1 $\n"
    " * $Log: metal_sha512_core.metal,v $\n"
    " * Revision 1.1  2026/05/16 03:57:29  dlr\n"
    " * Phase 2d.5.1 sha512_core.metal initial deposit -- AUTO-GENERATED by gpu/codegen/cl2metal.py from gpu/gpu_sha512_core.cl rev 1.2 with sha512.yaml overlay (skip simple template_emit_hit macro lines 309-314; arg_address_space template_finalize.data device const). FIRST 64-bit-state family on Metal cl2metal codegen path. ulong state[8] + uint h[16] decomposition via template_state_to_h() (BE ulong -> LE uint32 pairs); 128-byte block via template_finalize; 128-bit length encoding M[14..15]. Translator output verified compile-clean on iMac Intel + dev1 ARM64; cl2metal.py rev 1.4 _BLOCK_HELPERS_POINTER_STATE already registers sha512_block (no translator change required for this family ship). Companion to metal_common.metal rev 1.14 + gpu_metal.m rev 1.77.\n"
    " *\n"
    " *\n"
    " * Auto-generated by gpu/codegen/cl2metal.py from\n"
    " *   gpu_sha512_core.cl (RCS rev 1.2).\n"
    " *\n"
