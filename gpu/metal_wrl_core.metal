/*
 * $Revision: 1.1 $
 * $Log: metal_wrl_core.metal,v $
 * Revision 1.1  2026/09/17 03:23:50  dlr
 * Metal twin of gpu_wrl_core.cl, translated by codegen/cl2metal.py. Part of closing the OpenCL to Metal core-parity gap: 48 Metal cores against 55 OpenCL, now 55 to 55. Generated, not hand-written - do NOT edit directly; edit the OpenCL twin and re-run the translator, with Apple-specific tweaks in codegen/cl2metal_overrides/wrl.yaml.
 *
 *
 * Auto-generated by gpu/codegen/cl2metal.py from
 *   gpu_wrl_core.cl (RCS rev 1.3).
 *
...
static inline void whirlpool_compress_zero_iv(thread ulong *hash, thread ulong *block)
{
    ulong K[2][8];
    ulong state[2][8];
    int m = 0;
    ...
    for (int r = 0; r < 10; r++) {
        K[m^1][0] = MTL_WRL_OP(K[m], 0) ^ MTL_WRL_RC[r];
...
static inline void whirlpool_compress_cv(thread ulong *hash, thread ulong *block, thread ulong *cv)
{
    ulong K[2][8];
    ulong state[2][8];
    int m = 0;
