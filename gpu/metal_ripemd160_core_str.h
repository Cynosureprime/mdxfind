/* Auto-generated from metal_ripemd160_core.metal -- do not edit */
static const char metal_ripemd160_core_str[] =
    "/*\n"
    " * $Revisio" "n: 1.1 $\n"
    " * $Lo" "g: metal_ripemd160_core.metal,v $\n"
    " * Revision 1.1  2026/05/16 16:41:30  dlr\n"
    " * Phase 2d.6.1 ripemd160 Metal core -- Auto-generated by gpu/codegen/cl2metal.py from gpu_ripemd160_core.cl RCS rev 1.2 + overlay gpu/codegen/cl2metal_overrides/ripemd160.yaml. FIRST RIPEMD-family Metal port. 5-uint32 LE digest (matches sha1 dispatch shape) but distinct rmd160_block compression. Translator preserves &st.h[0] call sites verbatim via _BLOCK_HELPERS_POINTER_STATE; renames hex_byte_lc -> mtl_hex_byte_lc. Apple-specific overlay tweaks: template_finalize data device const; skip simple template_emit_hit macro.\n"
    " *\n"
    " *\n"
    " * Auto-generated by gpu/codegen/cl2metal.py from\n"
    " *   gpu_ripemd160_core.cl (RCS rev 1.2).\n"
    " *\n"
