/*
 * $Revision: 1.1 $
 * $Log: metal_hmac_streebog512_core.metal,v $
 * Revision 1.1  2026/05/16 20:00:43  dlr
 * Initial codegen output -- cl2metal.py from gpu/gpu_hmac_streebog512_core.metal.cl with overlay codegen/cl2metal_overrides/hmac_streebog512_core.metal.yaml
 *
 *
 * Auto-generated by gpu/codegen/cl2metal.py from
 *   gpu_hmac_streebog512_core.cl (RCS rev 1.2).
 *
...
constant ulong SBOB_SL64[8][256] = {
  {
...
void streebog_hash_priv(thread uchar *out, int hlen, device const uchar *data, int datalen)
{
    ulong h[8], e[8], m[8];
    ulong n = 0;
    int c;
...
static inline void template_digest_to_h(thread template_state &st)
{
    for (int i = 0; i < 16; i++) {
 ...
 * at mdxfind.c:30943. */
static inline void hmac_streebog512_run(thread uchar *out,
