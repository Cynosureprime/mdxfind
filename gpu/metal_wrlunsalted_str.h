/* Auto-generated from metal_wrlunsalted.metal -- do not edit */
static const char metal_wrlunsalted_str[] =
    "/* metal_wrlunsalted.metal — Pre-padded unsalted Whirlpool with mask expansion\n"
    " *\n"
    ...
    "}\n"
    "\n"
    "/* bswap32, bswap64 provided by metal_common.metal */\n"
    "\n"
    "/* Whirlpool round constants */\n"
    "constant ulong WRL_RC[10] = {\n"
    ...
    "static void whirlpool_compress(thread ulong *hash, thread ulong *block) {\n"
    "    ulong K[2][8];\n"
    "    ulong state[2][8];\n"
    "    int m = 0;\n"
    "\n"
    ...
    "\n"
    "    /* Fill mask positions -- operates on LE words (same as SHA1 kernel) */\n"
    ...
    "                uchar ch = charset_char(csid, final_digit);\n"
    "                int pos = app_start + i;\n"
    "                M32[pos >> 2] = (M32[pos >> 2] & ~(0xFFu << ((pos & 3) << 3)))\n"
    "                               | ((uint)ch << ((pos & 3) << 3));\n"
    "            }\n"
