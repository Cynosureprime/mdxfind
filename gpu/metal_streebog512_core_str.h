/* Auto-generated from metal_streebog512_core.metal -- do not edit */
static const char metal_streebog512_core_str[] =
    "/*\n"
    " * $Revisio" "n: $\n"
    " * $Lo" "g: $\n"
    " *\n"
    " * Auto-generated by gpu/codegen/cl2metal.py from\n"
    " *   gpu_streebog512_core.cl (RCS rev 1.2).\n"
    " *\n"
    ...
    " *\n"
    " * Streebog-512 differs from Streebog-256 (gpu_streebog256_core.cl) only in:\n"
    " *   - IV: 0x00 fill (vs 0x01)\n"
    " *   - Digest output: 64 bytes (vs 32) = full internal state h[8]\n"
    " *   - HASH_WORDS = 16 (vs 8) = 16 LE uint32 emit words\n"
    " *   - Iter feedback: 128 hex chars (vs 64) = exactly 2 Streebog blocks\n"
    " *\n"
    " * The compression function (streebog_g + streebog_hash_priv) is identical;\n"
    " * the hlen parameter selects the IV byte and output truncation.\n"
    " *\n"
    " * Cache key (R3): defines_str = \"HASH_WORDS=16,HASH_BLOCK_BYTES=64\".\n"
    " * Distinct cache entry vs streebog256 by source-text hash.\n"
    " */\n"
    "\n"
    "#ifndef HASH_WORDS\n"
    ...
    "    uint  h[HASH_WORDS];   /* 16 LE uint32 = 64 bytes */\n"
    "    uchar last_digest[64]; /* full 64-byte digest cached for iter feedback */\n"
    "};\n"
    "\n"
    ...
    "}\n"
    "\n"
    "/* Decompose 64-byte digest into h[16] LE uint32. */\n"
    ...
    "}\n"
    "\n"
    "/* template_finalize: streebog_hash_priv with hlen=64. */\n"
    ...
    "}\n"
    "\n"
    "/* template_iterate: -i loop step. Re-encode 64-byte digest as 128 hex chars\n"
    " * (= exactly 2 Streebog blocks of input), then re-hash. */\n"
    ...
    "}\n"
    "\n"
    "/* template_digest_compare: probe with leading 16 bytes of digest (h[0..3]). */\n"
