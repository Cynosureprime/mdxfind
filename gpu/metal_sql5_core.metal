/*
 * $Revision: 1.1 $
 * $Log: metal_sql5_core.metal,v $
 * Revision 1.1  2026/09/17 03:23:50  dlr
 * Metal twin of gpu_sql5_core.cl, translated by codegen/cl2metal.py. Part of closing the OpenCL to Metal core-parity gap: 48 Metal cores against 55 OpenCL, now 55 to 55. Generated, not hand-written - do NOT edit directly; edit the OpenCL twin and re-run the translator, with Apple-specific tweaks in codegen/cl2metal_overrides/sql5.yaml.
 *
 *
 * Auto-generated by gpu/codegen/cl2metal.py from
 *   gpu_sql5_core.cl (RCS rev 1.2).
 *
...
static inline void sql5_inner_finalize(thread template_state &st,
...
static inline void sql5_outer_sha1(thread template_state &st)
{
    uint M[16];
